        ...
        <div>
            ...
            <div className="Modal-Details-Text">
                <p>
                    ...
                    <li>
                        <a href="https://play.google.com/store/apps/details?id=com.loger.business_qari" target="blank">
                            Google Play
                        </a>{" "}
                        에서 사업주용 확인하기
                    </li>
                    <li>
                        <a href="https://play.google.com/store/apps/details?id=com.loger.person_qari" target="blank">
                            Google Play
                        </a>{" "}
                        에서 개인용 확인하기
                    </li>
